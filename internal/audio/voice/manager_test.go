...
func TestManagerBindsAndReleasesSessionOwnership(t *testing.T) {
	...
	if bindings.InputOwner != "sess_a" || bindings.InputMode != InputModeTranscribe {
	...
	if bindings.InputOwner != "sess_b" || bindings.InputMode != InputModeRaw {
	...
	if bindings.InputOwner != "" || bindings.InputMode != "" {
