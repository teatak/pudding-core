...
func TestClassifyToolCallCommandRisk(t *testing.T) {
	tests := []struct {
		...
		{name: "wrapper destructive", args: `{"scope":"project","command":"env rm -rf ."}`, class: RiskClassDestructive, operation: "env", lowRisk: false},
		{name: "utility wrapper", args: `{"scope":"project","command":"stdbuf -oL go test ./..."}`, class: RiskClassCommand, operation: "stdbuf", lowRisk: true},
		{name: "time wrapper", args: `{"scope":"project","command":"time go test ./..."}`, class: RiskClassCommand, operation: "time", lowRisk: true},
		{name: "env query", args: `{"scope":"project","command":"env"}`, class: RiskClassCommand, operation: "env", lowRisk: true},
		{name: "safe awk print", args: `{"scope":"project","command":"awk '{print $1}' main.go"}`, class: RiskClassCommand, operation: "awk", lowRisk: true},
		{name: "safe git branch query", args: `{"scope":"project","command":"git branch -a"}`, class: RiskClassCommand, operation: "git", lowRisk: true},
		{name: "git branch delete requires approval", args: `{"scope":"project","command":"git branch -D feat"}`, class: RiskClassCommand, operation: "git", lowRisk: false},
		{name: "safe git tag query", args: `{"scope":"project","command":"git tag -l"}`, class: RiskClassCommand, operation: "git", lowRisk: true},
		...
		{name: "awk system with tab requires approval", args: `{"scope":"project","command":"awk 'BEGIN { system\t(\"touch marker\") }'"}`, class: RiskClassCommand, operation: "awk", lowRisk: false},
		{name: "inline GOFLAGS toolexec requires approval", args: `{"scope":"project","command":"GOFLAGS='-toolexec=./scripts/wrapper' go test ./..."}`, class: RiskClassCommand, operation: "go", lowRisk: false},
		{name: "inline MAKEFLAGS requires approval", args: `{"scope":"project","command":"MAKEFLAGS='-j8' make build"}`, class: RiskClassCommand, operation: "make", lowRisk: false},
		{name: "git branch upstream value option requires approval", args: `{"scope":"project","command":"git branch --set-upstream-to=topic"}`, class: RiskClassCommand, operation: "git", lowRisk: false},
		{name: "git branch abbreviated upstream option requires approval", args: `{"scope":"project","command":"git branch --set-upstream-t=topic"}`, class: RiskClassCommand, operation: "git", lowRisk: false},
		{name: "git branch cancelled query requires approval", args: `{"scope":"project","command":"git branch --show-current --no-show-current -f topic HEAD"}`, class: RiskClassCommand, operation: "git", lowRisk: false},
		{name: "git branch short upstream joined option requires approval", args: `{"scope":"project","command":"git branch -utopic"}`, class: RiskClassCommand, operation: "git", lowRisk: false},
		{name: "git branch short delete joined option requires approval", args: `{"scope":"project","command":"git branch -dfeat"}`, class: RiskClassCommand, operation: "git", lowRisk: false},
		{name: "git tag short delete joined option requires approval", args: `{"scope":"project","command":"git tag -dv1.0"}`, class: RiskClassCommand, operation: "git", lowRisk: false},
		{name: "git tag cancelled query requires approval", args: `{"scope":"project","command":"git tag --points-at=HEAD --no-points-at newtag1"}`, class: RiskClassCommand, operation: "git", lowRisk: false},
		{name: "git config unset value option requires approval", args: `{"scope":"project","command":"git config --unset=user.name"}`, class: RiskClassCommand, operation: "git", lowRisk: false},
		{name: "git config urlmatch query", args: `{"scope":"project","command":"git config --get-urlmatch http https://example.invalid"}`, class: RiskClassCommand, operation: "git", lowRisk: true},
		{name: "git config file query", args: `{"scope":"project","command":"git config --file .git/config --get http.sslVerify"}`, class: RiskClassCommand, operation: "git", lowRisk: true},
		{name: "git config empty value write requires approval", args: `{"scope":"project","command":"git config --file .git/config http.sslVerify ''"}`, class: RiskClassCommand, operation: "git", lowRisk: false},
		{name: "git config edit subcommand requires approval", args: `{"scope":"project","command":"git config edit --file .git/config"}`, class: RiskClassCommand, operation: "git", lowRisk: false},
		{name: "command -v query", args: `{"scope":"project","command":"command -v sh"}`, class: RiskClassCommand, operation: "command", lowRisk: true},
		{name: "command -V query", args: `{"scope":"project","command":"command -V node"}`, class: RiskClassCommand, operation: "command", lowRisk: true},
		{name: "git branch list multiple patterns query", args: `{"scope":"project","command":"git branch --list main topic"}`, class: RiskClassCommand, operation: "git", lowRisk: true},
