export const queryKeys = {
  ...
  commandApprovals: (sessionID: string) => ["session", sessionID, "command-approvals"] as const,
  ...
  desktopApplicationIdentity: (appID: string, locale: string) => ["desktop", "application-identity", appID, locale] as const,
