// 品牌 logo SVG 集合。
// BrandIcon 统一负责背景、圆角、尺寸和 padding;各品牌组件只画 logo mark。
//
// 数据来源:simple-icons.org (gemini / openai / claude) + BuzzHive favicon + Xiaomi logo (mimo)。
// 各厂商品牌 / 商标 © 各自所有,这里只用于 UI 标识用途,不做商品化。
//
// app icon 设计原则:
//   1. 外层 span 控制背景、形状、尺寸和 mark padding
//   2. SVG 组件只保留 mark path,不自带背景
  ...
  return (
    <span
      className={cn(
        ...
        shape === "circle" ? "rounded-[50%]" : brandIconRadiusClass(radius),
